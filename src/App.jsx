...
import footer__logo from "./assets/footer__logo.svg";
                     ...
                     <div className="first__left">
                        <div className="title__wrap">
                           ...
                           <div className="title__wrap_item title__wrap_item_2">
                              <AnimationWrap delay={0.1} noAnimate className="title__wrap_item animation__left_t">
                                 Your
                              </AnimationWrap>
                              <div className="first__left_text_wrap">
                                 <AnimationWrap delay={0.3} noAnimate className="animation__scale">
                                    <p className="first__left_text hide-700">
                                       for instant viral video creation and effortless NFT minting in one click
                                    </p>
                                 </AnimationWrap>
                                 <AnimationWrap delay={0.3} noAnimate className="animation__right_t">
                                    <div className="ai">AI-Powered</div>
                                 </AnimationWrap>
                              </div>
                           </div>
                           <AnimationWrap delay={0.6} noAnimate className="animation__bottom_t">
                              <div className="title__wrap_item">AI Agent</div>
                           </AnimationWrap>
                        </div>
                        <AnimationWrap delay={0.8} noAnimate className="animation__top_t">
            ...
            <div className="_container">
               <section id="faq" className="faq">
                  <div className="faq__left">
                     ...
                     <AnimationWrap delay={0.5} noAnimate className="animation__left_t">
                        <img src={faq} alt="" className="faq__bg" />
                     </AnimationWrap>
                  </div>
                  <AnimationWrap delay={0.8} noAnimate className="faq__right animation__top_t">
                     <Spollers />
                  </AnimationWrap>
               </section>
