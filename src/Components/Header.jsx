...
const MenuItem = ({ href, text, delay, className, isShowDot = true, onClick }) => {
   return (
      <>
         <AnimationWrap noAnimate delay={delay} className={"menu__link " + className}>
            <a href={href} className="_scale_hover" onClick={onClick}>
               {text}
            </a>
         </AnimationWrap>
         {isShowDot && (
            <AnimationWrap noAnimate delay={delay + 0.3} className="animation__scale_big dot-wrap">
      ...
      <header className="header">
         <div className="header__left">
            ...
            <div className="header__full-menu">
               <div className="networks">
                  <NetworkItem href="#" src={tg} delay={0.5} className="animation__top" />
                  <NetworkItem href="#" src={x} delay={0.7} className="animation__bottom" />
                  <NetworkItem href="#" src={screen} delay={0.9} className="animation__top" />
                  <NetworkItem href="#" src={tools} delay={1.1} className="animation__bottom" />
               </div>
            </div>
            <AnimationWrap noAnimate className="animation__scale_big" delay={1}>
               <img src={line} alt="" className="line hide-700" />
         ...
         <nav className="menu header__full-menu">
            <MenuItem
               ...
               data-text="Gallery"
               text="Gallery"
               className={`animation__bottom _scale_hover ${activeItem === "Gallery" ? "active" : ""}`}
            ...
            <MenuItem
               ...
               delay={0.7}
               className={`animation__bottom_t _scale_hover ${activeItem === "App" ? "active" : ""}`}
            />
            <MenuItem
               href="#roadmap"
               text="Roadmap"
               ...
               delay={0.9}
               className={`animation__bottom_t _scale_hover ${activeItem === "Roadmap" ? "active" : ""}`}
            />
            <MenuItem
               href="#feedback"
               text="Feedback"
               ...
               delay={1.1}
               className={`animation__top_t _scale_hover ${activeItem === "Feedback" ? "active" : ""}`}
            />
            <MenuItem
               href="#faq"
               text="FAQ"
               ...
               isShowDot={false}
               className={`animation__bottom_t _scale_hover ${activeItem === "FAQ" ? "active" : ""}`}
            />
         </nav>
